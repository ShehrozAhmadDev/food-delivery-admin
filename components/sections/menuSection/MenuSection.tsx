    ...
    <div className="mx-auto">
      ...
      <div className="w-full flex justify-end py-3">
        <button
          ...
          className="text-white bg-gradient-to-r from-orange-600 to-yellow-400 rounded-lg hover:opacity-70 transition duration-300 p-2 w-[200px]"
        >
          Add Menu
        </button>
      </div>
              ...
              <td className="py-4 px-6">
                <div className="flex space-x-3">
                  <button
                    ...
                    className="text-white bg-gradient-to-r from-orange-600 to-yellow-400 rounded-lg hover:opacity-70 transition duration-300 p-2"
                  >
                    <FaEdit />
                  </button>
                  <button
